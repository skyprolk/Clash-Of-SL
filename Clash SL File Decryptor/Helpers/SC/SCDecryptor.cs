...
namespace CSFD.Core.Helpers
{
    class SCDecryptor
    {
        public static void Decrypt()
        {
            ...
            string[] files = Directory.GetFiles(@"In\Encrypted - SC", "*.sc");
            string output = @"Out\Decrypted - SC";
            ...
            if (filesAmount == 0)
            {
                MessageBox.Show("No SC files were found in the folder \"In\\Encrypted - SC.\""
            ...
            try
            {
                ...
                var success = MessageBox.Show("Successfully Decrypted SC Files!" + Environment.NewLine +
